...
SonarQube states [here](https://docs.sonarqube.org/latest/user-guide/security-rules/) that it utilizes security rules based on three major sources: [CWE (Common Weakness Enumeration)](https://www.owasp.org/index.php/Top_10-2017_Top_10), [SANS Top 25](https://www.owasp.org/index.php/Top_10-2017_Top_10) and [OWASP Top 10](https://www.owasp.org/index.php/Top_10-2017_Top_10). Even though SonarQube claims to have these security rules implemented but it failed to identify even a single vulnerability. It, instead, found linting and syntax-based bugs. This is probably due to the fact that SonarQube has very few security rules for JavaScript. It works better with Java.
